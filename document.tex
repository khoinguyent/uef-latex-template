...
In fact, the researching of SLR, including isolated (word-level) and continuous (phrase or sentences), has yielded significant results and developed rapidly in recent years \Citep*{lim2019isolated}\Citep*{li2018deep}\Citep*{mercanoglu2021chalearn}.
...
\section{Model}
\subsection{General algorithm for video classification }
A video is a collection of multi images which are represented by sequential. Therefore, the main idea of clarifying an action inside a video is analyzing frame by frame. In details, the general procedure of video recognition \citep{sivic2003video}\citep{niebles2010modeling} contains three key stages. 
