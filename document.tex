...
\begin{itemize}
    \item \textbf{Interesting points:} the points which are immune when an image is rotated, translated, scaled or intensified. For instance, pixels which are related to edges, corners or blobs can be considered as interest points inside an image.
\end{itemize}
